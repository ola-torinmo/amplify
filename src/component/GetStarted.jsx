      ...
      <div className="max-w-5xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12 items-center mt-6">
         ...
         <div className='md:w-[550px]'>
            ...
            <p className='text-[18px] mb-6 text-center md:text-left'>You're Not Just Building a Book, you're stepping into your mantle of influence. This is your moment. Your movement. AmplifyYOU starts September. Early bird offers available in August.</p>
            ...
            <div className="flex justify-center md:justify-start">
              <a href="https://selar.com/8g3657" target="_blank" rel="noopener noreferrer">
                <button className="mt-[20px] bg-[#E8B4B8] drop-shadow-sm text-white rounded-[10px] w-[299px] h-[51px] text-[16px]">
                Pre-order the book + Join the waitlist
                </button>
