    ...
    <section>
        ...
        <div className='flex flex-col items-center justify-center py-[75px] px-10 border border-[#DADEE3] rounded-[25px] mt-[40px] md:mx-[80px] mx-[20px] mb-12 '>
            ...
            <div className=' text-center mb-[16px] md:w-[920px] w-[300px] '>
                ...
                <p className='text-[16px] text-[#636363CC]'>We help expert women break free from invisibility, silence perfectionism, and show up with boldness, clarity, and confidence because brilliance should never stay buried.</p>
            </div>
